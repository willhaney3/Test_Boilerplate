...
namespace Test_Boilerplate.Tests
{
    ...
    public class Test_BoilerplateTestModule : AbpModule
    {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(Test_BoilerplateTestModule).GetAssembly());
        }
        ...
        private void SetupInMemoryDb()
        {
            ...
            IocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<Test_BoilerplateDbContext>>()
